...
export XLNX_SRC_PATH=${XLNX_SRC_PATH:=/proj/fisdata/fisusr/no_backup/RDI_fisusr_auviz/cv} 
...
export XILINX_SDX=${XILINX_SDX:=/proj/xbuilds/2016.4_sdx_daily_latest/installs/lin64/SDx/2016.4}
